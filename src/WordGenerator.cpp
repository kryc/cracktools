...
// Word length index returns the index of the first word of a given length
// in the given charset. For example, for the lower case charset and length 1,
// the index would be 0, for length 2 it would be 26
/* static */ void
