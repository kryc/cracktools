...
public:
    ...
    static std::string GenerateWord(const __uint128_t Value, std::string_view Charset);
    static std::string GenerateWordReversed(const __uint128_t Value, std::string_view Charset);
    ...
    static const size_t GenerateWord(std::span<char> Destination, const mpz_class& Value, std::string_view Charset);
    static const size_t GenerateWordReversed(std::span<char> Destination, const mpz_class& Value, std::string_view Charset);
    static const size_t GenerateWord(std::span<char> Destination, const __uint128_t Value, std::string_view Charset);
    static const size_t GenerateWordReversed(std::span<char> Destination, const __uint128_t Value, std::string_view Charset);
    static const size_t GenerateWord(std::span<char> Destination, const uint64_t Value, std::string_view Charset);
    static const size_t GenerateWordReversed(std::span<char> Destination, const uint64_t Value, std::string_view Charset);
    const std::string Generate(const uint64_t Value);
    const std::string GenerateReversed(const uint64_t Value);
    const std::string Generate(const __uint128_t Value);
    const std::string GenerateReversed(const __uint128_t Value);
    ...
    const size_t Generate(std::span<char> Destination, const __uint128_t Value);
    const size_t GenerateReversed(std::span<char> Destination, const __uint128_t Value);
    ...
    static const __uint128_t Parse128(std::string_view Word, std::string_view Charset);
    static const __uint128_t ParseReversed128(std::string_view Word, std::string_view Charset);
    static const __uint128_t Parse128(std::string_view Word, std::span<const uint8_t> LookupTable);
    static const __uint128_t ParseReversed128(std::string_view Word, std::span<const uint8_t> LookupTable);
    ...
    const __uint128_t Parse128(std::string_view Word) const { return Parse128(Word, m_Charset); };
    const __uint128_t ParseReversed128(std::string_view Word) const { return ParseReversed128(Word, m_Charset); };
    ...
    static void WordLengthIndex(const size_t WordLength, std::string_view Charset, __uint128_t& Index);
    ...
    static const __uint128_t WordLengthIndex128(const size_t WordLength, std::string_view Charset);
